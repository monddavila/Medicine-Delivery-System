                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            <li><a href="#">Order<a> <span class="bread-slash">/</span>
                                            </li>
                                            <li><span class="bread-blod">Information</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="sparkline8-list shadow-reset">
                                ...
                                <div class="sparkline8-graph"><button style="margin-bottom: -4.7%; margin-left: 47%" type="button" class="btn btn-custon-rounded-four btn-default" data-toggle="modal" data-target="#add"><i class="fa fa-cart-plus"></i></button> 
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    <div class="basic-login-inner modal-basic-inner">
                                                                        <h3 align="center">Add Order Info</h3>
                                                                        <form action="#">
                                                                            <div class="form-group-inner">
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-lg-8">
                                                                                        <label class="login2">Order Date</label>
                                                                                        <input type="date" class="form-control" placeholder="0" />
                                                                                    </div>
                                                                                    <div class="col-lg-4">
                                                                                        <label class="login2">Total Amount</label>
                                        ...
                                        <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="false" data-show-refresh="true" data-key-events="true" data-show-toggle="false" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="false" data-click-to-select="true" data-toolbar="#toolbar">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Customer</th>
                                                    <th>Order Date</th>
                                                    <th data-field="name" data-editable="false">Total Amount</th>
                                                    <th data-field="Address" data-editable="false">Cashier</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>John Loyd</td>
                                                    <td>05/12/20</td>
                                                    <td ><u style="color:"><strong>100,000.00</strong></u></td>
                                                        <td><span class="btn btn-xs btn-primary">Bia Alonzo</span></td>
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td>05/12/20</td>
                                                    <td ><u style="color:"><strong>100,000.00</strong></u></td>
                                                        <td><span class="btn btn-xs btn-warning">Jake Harden</span></td>
                                                    <td class="datatable-ct"><button class="btn btn-info btn-sm btn-custon-rounded-three" data-toggle="modal" data-target="#edit"><i class="fa fa-edit"></i></button> <button class="btn btn-danger btn-sm btn-custon-rounded-three"><i class="fa fa-times"></i></button>
                                            </td>
                                                </tr>
                                ...
                                <span class="adminpro-icon adminpro-warning-danger modal-check-pro information-icon-pro"></span>                                                        <div class="modal-login-form-inner">
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    <div class="basic-login-inner modal-basic-inner">
                                                                        <h3 align="center">Edit Order Info</h3>
                                                                        <form action="#">
                                                                            <div class="form-group-inner">
                                                                                <div class="row">
