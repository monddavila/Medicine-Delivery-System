                            ...
                            <div class="sparkline8-list shadow-reset">
                                <div class="sparkline8-hd">
                                    <div class="main-sparkline8-hd">
                                        <h1>Registered Customer Table</h1>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    <div class="basic-login-inner modal-basic-inner">
                                                                        ...
                                                                        <form action="customerregistrationform.php">
                                                                            <div class="form-group-inner">
                                                                                <div class="row">
                                                                                    <div class="col-lg-6">
                                                                                        <label class="login2">Name</label>
                                                                            ...
                                                                            <div class="login-btn-inner" style="margin-left: 8%">
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-lg-8">
                                                                                        <div class="login-horizental">
                                                                                            <button type="submit" class="btn btn-sm btn-warning" type="submit"><i class="fa fa-check"></i> Update</button>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
