                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Dilevery Information</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="sparkline8-list shadow-reset">
                                <div class="sparkline8-hd">
                                    <div class="main-sparkline8-hd">
                                        <h1>Delivery Information Table</h1>
                                        <div class="sparkline8-outline-icon">
                                            <a href="orderdetails.php"><button style="" type="button" class="btn btn-custon-rounded-four btn-success btn-xs"><i class="fa fa-eye"></i> View Orders</button></a> 
                                ...
                                <div class="sparkline8-graph"><button style="margin-bottom: -4.7%; margin-left: 47%" type="button" class="btn btn-custon-rounded-four btn-default" data-toggle="modal" data-target="#add"><i class="fa fa-truck"></i></button> 



                                    <div id="add" class="modal modal-adminpro-general default-popup-PrimaryModal fade bounceIn animated in" role="dialog">
                                <div class="modal-dialog">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    <div class="basic-login-inner modal-basic-inner">
                                                                        <h3 align="center">Add Delivery Info</h3>
                                                                        <form action="#">
                                                                            <div class="form-group-inner">
                                                                                <div class="row">
                                                                                    <div class="col-lg-6">
                                                                                        <label class="login2">Delivery Control No.</label>
                                                                                        <input type="text" class="form-control" placeholder="Enter Delivery Control No" />
                                                                                    </div>
                                                                                    <div class="col-lg-6">
                                                                                        <label class="login2">Order Control No</label>
                                                                            ...
                                                                            <div class="form-group-inner">
                                                                                <div class="row">
                                                                                    <div class="col-lg-4">
                                                                                        <label class="login2">Delivered By</label>
                                                                                        <input type="text" class="form-control" placeholder="Enter Sender" />
                                                                                    </div>
                                                                                    <div class="col-lg-4">
                                                                                        <label class="login2">Received By</label>
                                                                                        <input type="email" class="form-control" placeholder="Enter Receiver " />
                                                                                    </div>
                                                                                    <div class="col-lg-4">
                                                                                        <label class="login2">Date Delivered</label>
                                    ...
                                    <div class="datatable-dashv1-list custom-datatable-overright">
                                        ...
                                        <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="false" data-show-refresh="true" data-key-events="true" data-show-toggle="false" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="false" data-click-to-select="true" data-toolbar="#toolbar">
                                            <thead>
                                                <tr>
                                                    <th data-field="name" data-editable="false">Delivery Control No.</th>
                                                    <th data-field="Email" data-editable="false">Order Control No.</th>
                                                    <th data-field="Address" data-editable="false">Delivered By</th>
                                                    <th  data-field="contact" data-editable="false">Received By</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>BC1-1123-AAAZAW</td>
                                                    <td>1111111</td>
                                                    <td>Juan Carlo</td>
                                                    <td>Vice Ganda</td>
                                                    <td>08/12/20</td>
                                                    <td class="datatable-ct"><button class="btn btn-info btn-sm btn-custon-rounded-three" data-toggle="modal" data-target="#edit"><i class="fa fa-edit"></i></button> <button class="btn btn-danger btn-sm btn-custon-rounded-three"><i class="fa fa-times"></i></button>
                                            </td>
                                                </tr>
                                                 <tr>
                                                    <td>BC1-1123-AAAZAW</td>
                                        ...
                                        <div id="edit" class="modal modal-adminpro-general Customwidth-popup-WarningModal fade bounceIn animated in" role="dialog">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-close-area modal-close-df">
                                            <a class="close" data-dismiss="modal" href="#"><i class="fa fa-close"></i></a>
                                        ...
                                        <div class="modal-body">
                                <span class="adminpro-icon adminpro-warning-danger modal-check-pro information-icon-pro"></span>                                                        <div class="modal-login-form-inner">
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    <div class="basic-login-inner modal-basic-inner">
                                                                        <h3 align="center">Edit Delivery Info</h3>
                                                                        <form action="#">
                                                                            <div class="form-group-inner">
                                                                                <div class="row">
                                                                                    <div class="col-lg-6">
