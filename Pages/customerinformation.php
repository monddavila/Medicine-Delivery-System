                            ...
                            <div class="sparkline8-list shadow-reset">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    <div class="basic-login-inner modal-basic-inner">
                                                                        <h3 align="center">Add Customer Info</h3>
                                                                        <form action="#">
                                                                            ...
                                                                            <div class="form-group-inner">
                                                                                <div class="row">
                                                                                    <div class="col-lg-6">
                                                                                        ...
                                                                                        <input type="text" class="form-control" placeholder="Enter Customer Password" />
                                                                                    </div>
                                                                                    <div class="col-lg-6">
                                ...
                                <span class="adminpro-icon adminpro-warning-danger modal-check-pro information-icon-pro"></span>                                                        <div class="modal-login-form-inner">
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    <div class="basic-login-inner modal-basic-inner">
                                                                        <h3 align="center">Edit Customer Info</h3>
                                                                        <form action="#">
                                                                            <div class="form-group-inner">
                                                                                <div class="row">
                                                                                    <div class="col-lg-6">
                                                                            ...
                                                                            <div class="login-btn-inner" style="margin-left: 8%">
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-lg-8">
                                                                                        <div class="login-horizental">
                                                                                            <button class="btn btn-sm btn-warning" type="submit"><i class="fa fa-check"></i> Submit</button>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
