                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="sparkline8-list shadow-reset">
                                ...
                                <div class="sparkline8-graph"><button style="margin-bottom: -4.7%; margin-left: 47%" type="button" class="btn btn-custon-rounded-four btn-default" data-toggle="modal" data-target="#add"><i class="fa fa-trash"></i></button> 
                                        ...
                                        <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="false" data-show-refresh="true" data-key-events="true" data-show-toggle="false" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="false" data-click-to-select="true" data-toolbar="#toolbar">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>13:02</td>
                                                    <td>15:04</td>
                                                    <td class="datatable-ct"><button class="btn btn-danger btn-sm btn-custon-rounded-three"><i class="fa fa-times"></i></button>
                                            </td>
                                                </tr>
                                                 <tr>
                                                    <td>01/12/20</td>
