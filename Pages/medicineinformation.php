                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            <li><a href="#">Medicine<a> <span class="bread-slash">/</span>
                                            </li>
                            ...
                            <div class="sparkline8-list shadow-reset">
                                <div class="sparkline8-hd">
                                    <div class="main-sparkline8-hd">
                                        <h1>Medicine Information Table</h1>
                                ...
                                <div class="sparkline8-graph"><button style="margin-bottom: -4.7%; margin-left: 47%" type="button" class="btn btn-custon-rounded-four btn-default" data-toggle="modal" data-target="#add"><i class="fa fa-medkit"></i></button> 
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    <div class="basic-login-inner modal-basic-inner">
                                                                        <h3 align="center">Add Medicine Info</h3>
                                                                        <form action="#">
                                                                            <div class="form-group-inner">
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-lg-3">
                                                                                        <label class="login2">Retail Price</label>
                                                                                        <input type="number" class="form-control" placeholder="00.00" />
                                                                                    </div>
                                                                                    <div class="col-lg-8">
                                                                                    <div class="login-textarea-area">
                                                                                        <label class="login2">Description</label>
                                                                                        <textarea class="contact-message" cols="30" rows="50" style="width: 463px; height: 82px;" placeholder="Enter Medicine Description Here!.."></textarea>
                                                                                    </div>
                                                                                </div>
                                        ...
                                        <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="false" data-show-refresh="true" data-key-events="true" data-show-toggle="false" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="false" data-click-to-select="true" data-toolbar="#toolbar">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th data-field="Address" data-editable="false">Code</th>
                                                    <th  data-field="contact" data-editable="false">Category</th>
                                                    <th>Description</th>
                                                    <th>Price</th>
                                                    <th>Retail Price</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><img src="img/message/1.jpg" width="50"></td>
                                                    <td>Biogesic</td>
                                                    <td>B1</td>
                                                    <td>Tablet</td>
                                                    <td>This Medicine is not a Vitamin!!!!!!!</td>
                                                    <td ><i style="color: blue"><strong><u>$11.00</u></strong></i></td>
                                                    <td ><i style="color: blue"><strong>$15.00</strong></i></td>
                                ...
                                <span class="adminpro-icon adminpro-warning-danger modal-check-pro information-icon-pro"></span>                                                        <div class="modal-login-form-inner">
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    <div class="basic-login-inner modal-basic-inner">
                                                                        <h3 align="center">Edit Medicine Info</h3>
                                                                        <form action="#">
                                                                            <div class="form-group-inner">
                                                                                <div class="row">
                                                                                    <div class="col-lg-6">
