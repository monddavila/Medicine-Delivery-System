                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Driver Information</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="sparkline8-list shadow-reset">
                                <div class="sparkline8-hd">
                                    <div class="main-sparkline8-hd">
                                        <h1>Driver Information Table</h1>
                                ...
                                <div class="sparkline8-graph"><button style="margin-bottom: -4.7%; margin-left: 47%" type="button" class="btn btn-custon-rounded-four btn-default" data-toggle="modal" data-target="#add"><i class="fa fa-user-plus"></i></button> 
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    <div class="basic-login-inner modal-basic-inner">
                                                                        <h3 align="center">Add Driver Info</h3>
                                                                        <form action="#">
                                                                            ...
                                                                            <div class="form-group-inner">
                                                                                <div class="row">
                                                                                    <div class="col-lg-6">
                                                                                        ...
                                                                                        <input type="text" class="form-control" placeholder="Enter Driver Contact" />
                                                                                    </div>
                                                                                    <div class="col-lg-6">
                                                                                        <label class="login2">Email</label>
                                                                                        <input type="email" class="form-control" placeholder="Enter Driver Email '@' " />
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group-inner">
                                                                            ...
                                                                            <div class="form-group-inner">
                                                                                <div class="row">
                                                                                    <div class="col-lg-6">
                                                                                        ...
                                                                                        <input type="text" class="form-control" placeholder="Enter Driver Password" />
                                                                                    </div>
                                                                                    <div class="col-lg-6">
                                                                                        <label class="login2">Password</label>
                                                                                        <input type="password" class="form-control" placeholder="Enter Driver Password" />
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                        ...
                                        <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="false" data-show-refresh="true" data-key-events="true" data-show-toggle="false" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="false" data-click-to-select="true" data-toolbar="#toolbar">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>United State of India</td>
                                                    <td>+45778888777</td>
                                                    <td><span class="btn btn-success btn-xs">Enable!</span></td>
                                                    <td>Web101</td>
                                                    <td>******</td>
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td>United State of India</td>
                                                    <td>+45778888777</td>
                                                    <td><span class="btn btn-warning btn-xs">Disable!</span></td>
                                                    <td>Web101</td>
                                                    <td>******</td>
                                                    <td class="datatable-ct"><button class="btn btn-info btn-sm btn-custon-rounded-three" data-toggle="modal" data-target="#edit"><i class="fa fa-edit"></i></button> <button class="btn btn-danger btn-sm btn-custon-rounded-three"><i class="fa fa-times"></i></button>
                                            </td>
                                ...
                                <span class="adminpro-icon adminpro-warning-danger modal-check-pro information-icon-pro"></span>                                                        <div class="modal-login-form-inner">
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    <div class="basic-login-inner modal-basic-inner">
                                                                        <h3 align="center">Edit Driver Info</h3>
                                                                        <form action="#">
                                                                            <div class="form-group-inner">
                                                                                <div class="row">
                                                                                    <div class="col-lg-6">
